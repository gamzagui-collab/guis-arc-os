...
test("VIEW-only assignee can read detail but receives no action controls",()=>assert.deepEqual(visibility({access:"VIEW"}),{showActionForm:false,showCompletionRequest:false,showCompletionConfirm:false,showRework:false}));
...
test("same-company non-assignee receives no action controls",()=>assert.deepEqual(visibility({user:"other"}),{showActionForm:false,showCompletionRequest:false,showCompletionConfirm:false,showRework:false}));
