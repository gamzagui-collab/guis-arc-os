...
const keys=["site_manager","gc_staff","contractor_manager","contractor_b_manager","contractor_assignee","no_access","field_worker"];
...
if(result.verification?.users!==7||result.verification?.memberships!==8||result.verification?.issueEntitlements!==6)throw new Error("Issue E2E fixture read-back failed.");
