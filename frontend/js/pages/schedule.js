...
export function renderSchedule(root){
  ...
  root.innerHTML = `<div class="section-head"><div><h2>현장일정</h2><p>자재반입 · 타설계획 · 장비운영 · 공정일정을 기록합니다.</p></div><button id="addConcretePlanBtn" class="primary-btn">타설계획 추가</button></div>
